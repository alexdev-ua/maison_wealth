<footer class="page-screen auto-height" id="footerScreen">
	<div class="red-bg top-padding pb-4">
		<div class="wraper">
			<div class="text-center">
				<p class="footer-label mb-3">Connect with us</p>
				<a href="https://www.linkedin.com/company/maison-wealth/" target="_blank" class="custom-link white-link mr-2">LN <img src="/images/ic_arrow_right_white.svg" /></a>
				<a href="https://www.facebook.com/maisonwealth" target="_blank" class="custom-link white-link ml-2 mr-2">FB <img src="/images/ic_arrow_right_white.svg" /></a>
				<a href="https://t.me/maisonwealth" target="_blank" class="custom-link white-link ml-2 mr-2">TG <img src="/images/ic_arrow_right_white.svg" /></a>
				<a href="https://instagram.com/maisonwealth" target="_blank" class="custom-link white-link ml-2">IG <img src="/images/ic_arrow_right_white.svg" /></a>

				<div class="mt-5 pt-1">
					<img src="/images/ic_company_name_short.svg" class="company-name" />
				</div>
			</div>
			<div class="row mt-5">
				<div class="col-6">
				...
				<div class="col-6 text-right">
					...
					<button class="custom-link white-link footer-link mt-2 pop-up-btn float-right p-0" data-pop-up="#personalConsultPopup">Start to Invest</button>
				</div>
			</div>
