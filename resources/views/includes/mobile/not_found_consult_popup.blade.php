<div class="pop-up" id="notFoundConsultPopup">
    <div class="wraper">
        <div class="pop-up-header">
            <button class="close-pop-up-btn pop-up-btn" data-pop-up="#notFoundConsultPopup"><img src="/images/ic_close.svg"></button>
        </div>
        <div class="pop-up-content pb-5">
            <form class="custom-form" method="POST" action="{{route('send-request')}}" id="notFoundConsultationForm">
                ...
                <div class="row mt-3 pt-3">
                    ...
                    <div class="col-12">
                        <div id="notFoundConsultationRecaptcha" data-badge="inline"></div>
                    </div>
