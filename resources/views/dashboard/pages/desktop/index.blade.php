...
<div class="row m-0 p-3" style="height: 100%; overflow: auto;">
	<p class="main-title col-12 text-center mt-4 mb-5"><b><i class="fas fa-columns mr-2"></i>Welcome to Sunny DVG Control Panel!</b></p>

	<div id="accordion" class="main-links-block row">
