                ...
                <div class="col-6">
                    <div class="dash-tabs-panel mt-3" id="pageTranslatesPanel">
                        ...
                        <div class="dash-tab @if($key == 0)active-tab @endif" id="pageTranslateTab_{{$lang->code}}" data-panel="#pageTranslatesPanel">
                            ...
                            <div class="form-group mt-3">
                                <label>Description</label>
                                <textarea name="page_description_{{$lang->id}}" class="form-control dash-input" autocomplete="off" rows="2">@if($record->translate($lang->id)){{$record->translate($lang->id)->page_description}}@endif</textarea>
                            </div>
                        </div>
                        @endforeach
                    </div>
