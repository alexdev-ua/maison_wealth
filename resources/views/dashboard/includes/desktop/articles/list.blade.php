...
<div class="dash-table-row row" data-id="{{$record->id}}">
    ...
    <div class="dash-table-column description-column col-6 pt-4">
        {{$record->translate($dashLang)->description}}
    </div>

    <div class="dash-table-column options-column col-2">
        <a href="/dashboard/articles/edit?id={{$record->id}}" class="dash-table-option-btn dash-btn blue-btn"><i class="fas fa-pencil-alt"></i></a>
