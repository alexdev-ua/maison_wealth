...
<div class="dash-table-row row" data-id="{{$record->id}}">
    ...
    <div class="dash-table-column text-column col-7 pt-4">{{$record->translate($dashLang)->text}}</div>
    <div class="dash-table-column author-column col-2 pt-4">{{$record->translate($dashLang)->author}}</div>
