...
<div class="page-screen active-screen opened article-screen">
    <div class="wraper">
        <p class="article-title page-screen-heading top-padding">Property in<br>Dubai</p>
        <div class="row mb-5">
            <div class="col-6 offset-6">
                <p class="page-screen-heading red-text">Guide to income investing</p>
    ...
    <div class="row">
        <div class="col-6 animated-block slide-from-top pr-0">
            <div class="page-block-content p-0">
                <img src="/images/im_blog_article_banner.jpg" class="page-screen-bg-image animated-image left-animated-image" />
            </div>
        </div>
        <div class="col-6 animated-block slide-from-bottom pl-0">
            <div class="page-block-content p-0">
                <img src="/images/im_blog_article_banner.jpg" class="page-screen-bg-image animated-image right-animated-image" />
            </div>
        </div>
    </div>
</div>
...
<!-- why screen -->
<div class="page-screen why-screen">
...
<div class="page-screen invest-options-screen">
    <div class="row">
        <div class="col-6 animated-block slide-from-bottom pr-0">
            <div class="content-wraper page-block-content white-bg">
                ...
                <p class="page-block-description font-normal light-weight mt-4 mb-2 text-left">Investment in the fourth most visited place, popular with tenants, guarantees a constant and stable profit. </p>
    ...
    <div class="row">
        ...
        <div class="col-6 animated-block slide-from-bottom pl-0">
            <div class="page-block-content white-bg">
                ...
                <p class="page-block-description font-normal light-weight mt-4 mb-2 text-left">The city has a high demand, so there is a high return on investment — 7-10% per year, depending on the object's location.</p>
