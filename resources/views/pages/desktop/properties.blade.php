...
<div class="page-screen active-screen opened white-bg invest-screen" id="popularLocationsScreen">
    <div class="wraper top-padding">
        <div class="row">
            <div class="col-6">
                <div class="col-12 mb-4 mt-4 pt-3">
...
<div class="page-screen auto-height properties-screen" id="propertiesScreen">
    <div class="wraper animated-block slide-from-bottom pt-5 white-bg">
