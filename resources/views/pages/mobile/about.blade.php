...
@section('content')
<!-- top screen -->
<div class="page-screen meet-company-screen  auto-height">
    ...
    <div class="wraper text-center">
        <div class="auto-height page-block-content pl-0 pr-0">
            ...
            <a href="" class="main-btn black-btn inverted-btn d-inline-block mt-4">Start to invest <span class="btn-icon"></span></a>
        </div>
    </div>
</div>
<!-- end top screen -->
...
<!-- our focus screen -->
<div class="page-screen auto-height focus-screen gray-bg">
    <div class="wraper">
...
<div class="page-screen auto-height invest-options-screen">
    ...
    <div class="wraper auto-height mt-4 mb-5">
...
<div class="page-screen auto-height gray-bg financial-advantages-screen">
    <img src="/images/im_financial_advantages_banner.jpg" class="page-screen-bg-image" />
    <div class="wraper gray-bg auto-height mt-4 mb-5">
