...
<div class="page-screen auto-height pluses-screen">
    <div class="wraper">
        ...
        <div class="pluses-list mt-5 mb-5">
            <div class="plus-item">
...
<div class="page-screen features-screen">
    <div class="carousel features-carousel">
        <div class="carousel-slide feature-slide">
            <div class="wraper red-bg page-block-content">
                <p class="page-screen-heading white-text text-left mb-2">NÁLU Luxury Beachfront Residences consists of 12 exclusive luxury apartments, making it the most attractive development in Puerto Morelos.</p>
        ...
        <div class="carousel-slide feature-slide">
            <div class="wraper gray-bg page-block-content">
...
<div class="page-screen auto-height gray-bg personal-consultation-screen">
    <div class="wraper gray-bg">
        <p class="page-screen-heading mb-4 mt-4"><span class="gray-text">Start investing</span> correctly, without unnecessary risks and with the greatest benefit, <span class="gray-text">think it over and we will be there for you.</span></p>
    </div>
