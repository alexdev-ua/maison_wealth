...
<div class="page-screen active-screen opened direction-screen">
    <img src="{{$direction->bannerImage()}}" class="page-screen-bg-image full-height" />
    <div class="wraper">
        <div class="fixed-block left-block">
            <p class="fixed-block-title white-text">{{$direction->country($activeLang)}}<br>({{$direction->translate($activeLang)->title}})</p>
            <span class="property-label">{{$direction->translate($activeLang)->page_label}}</span>
        </div>
...
<div class="page-screen auto-height pluses-screen">
    <div class="animated-block resized-block white-bg pt-4 pb-4">
        <div class="wraper">
            <p class="page-screen-heading">{{$direction->translate($activeLang)->page_description}}</p>
